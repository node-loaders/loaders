...
describe('chain', () => {
  ...
  beforeEach(() => {
    order = [];
    returnValue = {};
    spy1 = jestMock.fn<LoaderFunction>().mockImplementation((arg1, arg2, arg3) => {
      order.push('spy1');
      return arg3!(arg1, arg2);
    });
    spy2 = jestMock.fn<LoaderFunction>().mockImplementation(() => {
      order.push('spy2');
      return returnValue;
    });
  });
  ...
  describe('createChain', () => {
    it('should chain functions', () => {
      const arg1 = {};
      const arg2 = {};
      expect(createChain(spy1, spy2)(arg1, arg2)).toBe(returnValue);
  ...
  describe('createChainMethod', () => {
    it('should chain properties', () => {
      ...
      const arg1 = {};
      const arg2 = {};
      expect(createChainMethod([object1, object2], 'spy')(arg1, arg2, spy2)).toBe(returnValue);
